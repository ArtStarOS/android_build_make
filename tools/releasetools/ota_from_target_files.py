...
""" % bcb_dev)
  ...
  prev_build_date = source_info.GetBuildProp("ro.artstar.build_date")
  build_date = target_info.GetBuildProp("ro.artstar.build_date")
...
def WriteIncrementalOTAPackage(target_zip, source_zip, output_file):
  ...
  error_msg = "Failed to apply update, please download full package at ArtStarOS" + device

  prop_path = "/" + GetSystemBasePath() + "/system/build.prop"

  source_version_prop = "ro.artstar.version.display"
